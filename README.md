...
```bash
npx create-next-app -e https://github.com/Karan-3108/starter-kit my-cosmwasm-dapp
# or
yarn create next-app -e https://github.com/Karan-3108/starter-kit my-cosmwasm-dapp
```
...
docker run -it \
  -p 26656:26656 \
  -p 26657:26657 \
  -e STAKE_TOKEN=uraptorx \
  ghcr.io/Karan-3108/raptor:v2.1.0 \
  ./setup_and_run.sh raptor16g2rahf5846rxzp3fwlswy08fz8ccuwk03k57y
```

More information can be found [in the Raptor docs here](https://docs.raptornetwork.io/smart-contracts-and-raptord-development/raptord-local-dev-setup).
